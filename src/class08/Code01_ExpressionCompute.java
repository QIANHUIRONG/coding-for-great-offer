...
/*
题目：给定一个字符串str，str表示一个公式，公式里可能有整数、加减乘除符号和左右括号。
	返回公式的计算结果难点在于括号可能嵌套很多层，
	str="48*((70-65)-43)+81"，返回-1816
	str="3+14"，返回7。str="3+(14)"，返回7
	1，可以认为给定的字符串一定是正确的公式，即不需要对str做公式有效性检查
	2，如果是负数，就需要用括号括起来，比如"4*(-3)"但如果负数作为公式的开头或括号部分的开头，则可以没有括号，比如"-34"和"(-34)"都是合法的
	3，不用考虑计算过程中会发生溢出的情况。
时间：7
时间复杂度：O(N)
是否属于高频内容打包课：是
类似的括号嵌套类题目：leetcode394、726、772
 */
